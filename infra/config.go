// Package infra contains the lowest-level resources needed by the microservice:
// configuration, the IoC container, lifecycle management, and logging setup.
package infra
...
// validated *Config. On success goconf also prints a masked config table to stdout.
